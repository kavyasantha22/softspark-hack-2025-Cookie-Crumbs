...
struct HomeView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            // Refresh spark statuses when home view appears
...
private struct EventCard: View {
    ...
    private func demoImageForEvent(_ event: Event) -> some View {
        let imageURL: String
        
        switch event.name.lowercased() {
        case let name where name.contains("chess"):
            imageURL = "https://images.unsplash.com/photo-1529699211952-734e80c4d42b?w=500&h=300&fit=crop"
